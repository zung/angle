...
public class AngleFont
{
	...
	public AngleFont(float fontSize, Typeface typeface, int space, int red,
	...
	public void loadTexture(GL10 gl)
	{
		...
		if (p < 11)
		{
			...
			/*
			 * for (int y=0;y<256;y++) { paint.setARGB(255, 255, y, 30);
			 * canvas.drawLine(0, y, 256, y, paint); }
			 */
			for (int c = 0; c < FONT_CHARS; c++)
				canvas.drawText(sAvailableChars.substring(c, c + 1), mCharLeft[c],
						mCharTop[c] - minTop, paint);
