...
public class AngleSegmentCollider 
{
	...
	public void draw(GL10 gl)
	{
		...
		vertices = ByteBuffer.allocateDirect(2*2*4)
	...
	{
		return	Math.abs((((mDir.mX)*((other.mObject.mVisual.mCenter.mY+other.mCenter.mY)-mObject.mVisual.mCenter.mY+mA.mY))-
			  	 ((mDir.mY)*((other.mObject.mVisual.mCenter.mX+other.mCenter.mX)-mObject.mVisual.mCenter.mX+mA.mX)))/
			  	 	mLength);
	}
}
