...
public class Tutorial07 extends Activity
{
	...
	class MyGameEngine extends AnglePhysicsGameEngine //Our physics game engine  
	{
		...
		public void addObject(AnglePhysicObject object)
		{
			...
			mSprites.addReference((AngleAbstractSpriteReference) object.mVisual); //Add sprite to mSprites when object is added
		}
		...
		public void removeObject(AnglePhysicObject object)
		{
			...
			mSprites.removeRefernece((AngleAbstractSpriteReference) object.mVisual); //Remove sprite when object is removed
		}
		...
		public void run()
		{
			...
			for (int l=0;l<mBallsCount;l++)
			{
				...
				if ((mBalls[l].mVisual.mCenter.mX<-mBallSprite.mWidth/2)||(mBalls[l].mVisual.mCenter.mY<-mBallSprite.mWidth/2)||(mBalls[l].mVisual.mCenter.mX>AngleMainEngine.mWidth+mBallSprite.mWidth/2)||(mBalls[l].mVisual.mCenter.mY>AngleMainEngine.mHeight+mBallSprite.mWidth/2))
				{
